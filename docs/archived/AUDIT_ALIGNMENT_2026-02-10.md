...
**Date:** 2026-02-10  
**Archived:** 2026-03-22 → `docs/archived/` (line references and journey details may be stale; use [`../PLATFORM_STATUS.md`](../PLATFORM_STATUS.md) and [`../LOOP_STANDARD.md`](../LOOP_STANDARD.md) for current behavior).  
...
- `episodes/training_hub/index.html` (Training Hub): quest map + module router.
- `episodes/seed_builder_studio/index.html` (Seed Builder Studio): module router.
